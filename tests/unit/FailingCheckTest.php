<?php
class FailingCheckTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Check
     */
    ...
    {
        $this->check = new Check(new FailingCheckState);
    }
     ...
     * @covers FailingCheckState::or_condition
     ...
     * @covers FailingCheckState::throw_exception
