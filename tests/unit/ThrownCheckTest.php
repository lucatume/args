<?php
class ThrownCheckTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Check
     */
    ...
    {
        $this->check = new Check(new ThrownCheckState);
    }
     ...
     * @covers ThrownCheckState::or_condition
     * @uses   Check::has_thrown
     */
     ...
     * @covers ThrownCheckState::throw_exception
     * @uses   Check::has_thrown
     */
